...
setInterval(() => {
    if(LoginQueue.length != 0){
        // console.log("LoginQue Length = " + LoginQueue.length)
        // console.log("ALTRPoccess Length = " + Object.keys(ALTProccessOBJ).length)
        // console.log("AFKAlts length = " + Object.keys(AFKAlts).length)
